...
- La base de données PostgreSQL doit être la dernière barrière de défense hermétique.
...
3. **Rejet d'écriture Client A** : UPDATE sur les 5 fixtures Org A retourne `0` lignes affectées, et Pro A vérifie l'intégrité des données d'origine.
